    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('antenna', models.ForeignKey(verbose_name='Antena', to='device.Antenna')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(verbose_name='Conex\xe3o com device', to='contenttypes.ContentType', null=True)),
                ('nic_sink', models.ForeignKey(related_name='soft_transcoder_nic_sink', to='device.NIC')),
                ('nic_src', models.ForeignKey(related_name='soft_transcoder_nic_src', to='device.NIC')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(verbose_name='Conex\xe3o com device', to='contenttypes.ContentType', null=True)),
                ('nic_sink', models.ForeignKey(verbose_name='Interface de rede interna', to='device.NIC')),
                ('storage', models.ForeignKey(to='device.Storage')),
            ],
            options={
