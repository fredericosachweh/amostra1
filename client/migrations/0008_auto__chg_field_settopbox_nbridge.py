...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SetTopBox.nbridge'
        db.alter_column(u'client_settopbox', 'nbridge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nbridge.Nbridge'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'SetTopBox.nbridge'
        db.alter_column(u'client_settopbox', 'nbridge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nbridge.Nbridge'], null=True))
