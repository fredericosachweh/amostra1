...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SetTopBox.mac'
        db.alter_column(u'client_settopbox', 'mac', self.gf('client.fields.MACAddressField')(unique=True, max_length=17))

    def backwards(self, orm):

        # Changing field 'SetTopBox.mac'
        db.alter_column(u'client_settopbox', 'mac', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
