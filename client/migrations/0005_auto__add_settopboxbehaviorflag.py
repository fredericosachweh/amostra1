...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SetTopBoxBehaviorFlag'
        db.create_table(u'client_settopboxbehaviorflag', (
        ...
        db.send_create_signal(u'client', ['SetTopBoxBehaviorFlag'])


    def backwards(self, orm):
        # Deleting model 'SetTopBoxBehaviorFlag'
        db.delete_table(u'client_settopboxbehaviorflag')
