...
def dashboard(request):
    return direct_to_template(request,'admin/monitoramento/dashboard.html')
...
def channel_tree(request):
    ...
    response = render_to_response("admin/monitoramento/tree.html",
...
def mon_export(request):
    ...
    response = render_to_response("admin/monitoramento/export.html",
