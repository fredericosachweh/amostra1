...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tastypie_apikey', 'key', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'ApiKey.key'
        db.alter_column(u'tastypie_apikey', u'key', self.gf(u'django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        u'tastypie.apikey': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 4, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
