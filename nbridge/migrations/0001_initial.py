...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Nbridge'
        db.create_table(u'nbridge_nbridge', (
            ...
            ('middleware_addr', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('debug', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('debug_port', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('log_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('env_val', self.gf('django.db.models.fields.CharField')(default=u'production', max_length=20)),
        ))
        db.send_create_signal(u'nbridge', ['Nbridge'])


    def backwards(self, orm):
        # Deleting model 'Nbridge'
        db.delete_table(u'nbridge_nbridge')
