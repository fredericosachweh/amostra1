...
urlpatterns = patterns('',
    ...
    url(r'^auth/(?P<mac>[0-9A-F:]{10,20})/.*$', 'box.views.auth',
        name='box_auth'),
    url(r'^programme_info/$', 'box.views.programme_info',
        name='programme_info'),
    url(r'^guide_programmes/$', 'box.views.guide_programmes',
        name='guide_programmes'),
    url(r'^guide_mount_line_of_programe/$',
        'box.views.guide_mount_line_of_programe',
        name='guide_mount_line_of_programe'),
    url(r'^remote_log/$', 'box.views.remote_log',
        name='box_remote_log'),
    url(r'^setup/$', 'box.views.setup', name='setup'),
    url(r'^ping$', 'box.views.ping', name='ping'),
    url(r'^debug/(?P<path>.*)$', 'django.views.static.serve', {
            'document_root':
                os.path.join(settings.PROJECT_ROOT_PATH, 'frontend/src/'),
        }),
