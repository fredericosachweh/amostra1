...
class ConnectionTest(TestCase):
    ...
    def test_scan_channel(self):
        ...
        r = c.new_execute('/usr/bin/dvblast -a 2 -f 3090000 -s 2220000')
        print(r)
    
    def test_control_dvb(self):
        self.assertFalse(True, 'Criar o controle de processos do dvb')
    
    def test_control_multicat(self):
        self.assertFalse(True, 'Criar o controle de processos do multicat')
